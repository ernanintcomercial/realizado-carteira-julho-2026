...
- `WWWPD010.xlsx`: fechamento do mês atual até o último dia útil;
- `WWWPD019.xlsx`: metas comerciais de 2026;
- `Extração em Tabela (28).xlsx`: carteira completa de 2026;
...
- realizado: 28/07/2026 (último dia útil anterior);
- carteira: janeiro a 28/07/2026;
